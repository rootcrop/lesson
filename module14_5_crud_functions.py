...
def initiate_db_users():          # инициализируем базу User
    cursor.execute('''
...
def initiate_db_products():          # инициализируем базу Products
    cursor.execute('''               
...
def add_db_products(title, description, imagename, price=1000 ):            # заполняем Products
    # insert ver1
