...
Примечания: Для обозначения асинхронной функции используйте оператор async.
...
# - -- -  - -- - - -- - - -- - - -- -
# async / asyncio / template / шаблон
# - -- -  - -- - - -- - - -- - - -- -
#async def func1 ...
    #await asyncio.2do      # ждем исполнения

#async def main()           # функция главного цикла
    #task1=asyncio.create_task( func1() )
    #await task1            # ждем исполнения

#asyncio.run(main())    # запускаем главный цикл
    #await ждем исполнения
