from app_users2.backend.udb import Base
...
#from app_users2.models import task    # импорт одного класса модели в модуль с другим, чтобы таблицы были видны друг другу
from app_users2.models import *
