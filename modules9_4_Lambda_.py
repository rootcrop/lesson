...
Данный код: write = get_advanced_writer('example.txt')
...
class MysticBall:
    def __init__(self, *words):
        self.words=words
    def __call__(self):     # если есть такой метод у класса, то его объект можно вызвать как функцию
        return choice(self.words)

first_ball = MysticBall('Да', 'Нет', 'Наверное')
print(first_ball()); print(first_ball()); print(first_ball())
