...
from module14_52_bot_config import *     # в config      настройка АПИ и цен
from module14_52_bot_keyboards import *  # в keyboards   вывод меню через клавиатуру
import module14_52_bot_texts as text     # в text        тексты для вывода информации, описание игр
...
from module14_52_admin import *             # urban-university.ru/members/courses/course999421818026/20240201-0000lekcia-plan-napisania-adminpaneli-925364922666
from module14_52_crud_functions import *
...
async def get_buying_list(message):
    for i in range (0,len(get_all_products())):
...
@dp.message_handler()
async def start (message): await message.answer( 'нажмите /start или введите команду /start, чтобы начать общение' )
